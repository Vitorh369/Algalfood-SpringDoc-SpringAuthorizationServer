...
insert into permissao (id, nome, descricao) values (5, 'CONSULTAR_USUARIOS_GRUPO_PERMISSOES', 'Permite consultar usuários');
insert into permissao (id, nome, descricao) values (6, 'EDITAR_USUARIOS_GRUPO_PERMISSOES', 'Permite criar ou editar usuários');
