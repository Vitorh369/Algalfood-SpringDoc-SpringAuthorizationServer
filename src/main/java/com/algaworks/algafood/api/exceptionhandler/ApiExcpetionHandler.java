...
public class ApiExcpetionHandler extends ResponseEntityExceptionHandler { 
	...
	@ExceptionHandler(EntidadeNaoEncotradaException.class)//ESSA ANOTACAO @ExceptionHandler, VAI PEGAR TODAS AS EXECOES DE EntidadeNaoEncontradaException
	public ResponseEntity<?> handleEntidadeNaoEncotradaException(EntidadeNaoEncotradaException ex, WebRequest request){
	...
	@ExceptionHandler(EntidadeEmUsoException.class)//ESSA ANOTACAO @ExceptionHandler, VAI PEGAR TODAS AS EXECOES DE EntidadeNaoEncontradaException
	...
	@ExceptionHandler(NegocioException.class)//ESSA ANOTACAO @ExceptionHandler, VAI PEGAR TODAS AS EXECOES DE NegocioException
