...
public interface CozinhaControllerOPenApi {
	...
	@PageableParameter
	@Operation(summary = "Lista cozinha com paginção")
	...
	CozinhaModel adicionar(@RequestBody(description = "Representação de uma cozinha nova", required = true) CozinhaInput cozinhaInput);
	...
	@Operation(summary = "Exclu uma cozinha por ID", responses = {
