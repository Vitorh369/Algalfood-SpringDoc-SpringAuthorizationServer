...
@Tag(name = "Cidades")
public interface CIidadeControllerOpenApi {
	...
	@Operation(summary = "Busca uma cidade por id", responses = {
			...
			@ApiResponse(responseCode = "400", description = "ID da cidade inválida"),
	...
	@Operation(summary = "Adiciona uma cidade", description = "Cadastro de uma cidade,"
			+ " necessita de um estado e um nome válido")
	CidadeModel adicionar(@RequestBody(description = "Representação uma nova cidade", required = true) CidadeInput cidadeInput);

	@Operation(summary = "Atualiza uma cidade", responses = {
			@ApiResponse(responseCode = "200"),
			@ApiResponse(responseCode = "400", description = "ID da cidade inválida"),
	...
	@Operation(summary = "Excluir uma cidade", responses = {
