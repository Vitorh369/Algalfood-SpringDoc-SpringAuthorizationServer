...
import com.algaworks.algafood.api.v1.controller.EstaticaController;
...
import com.algaworks.algafood.api.v1.controller.RestauranteFormaPagementoController;
...
public class AlgaLinks {
	...
	public Link linkToEstatisticas(String rel) {
		return linkTo(EstaticaController.class).withRel(rel);
	}
	...
	public Link linkToEstatisticasVendasDiarias(String rel) {
		...
		String pedidosUrl = linkTo(methodOn(EstaticaController.class).consultarVendasDiarias(null, null)).toUri()
				.toString();
	...
	public Link linkToRestauranteFormasPagamento(Long restauranteId, String rel) {
		return linkTo(methodOn(RestauranteFormaPagementoController.class).listar(restauranteId)).withRel(rel);
	}
	...
	public Link linkToRestauranteFormaPagamentoDesassociacao(Long restauranteId, Long formaPagamentoId, String rel) {
		...
		return linkTo(methodOn(RestauranteFormaPagementoController.class).desassociar(restauranteId, formaPagamentoId))
				.withRel(rel);
	}

	public Link linkToRestauranteFormaPagamentoAssociacao(Long restauranteId, String rel) {
		return linkTo(methodOn(RestauranteFormaPagementoController.class).associar(restauranteId, null)).withRel(rel);
	}
